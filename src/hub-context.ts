...
export function initContext(): {
  ...
  const hubContext = reactive({
    ...
    user: {
      data: {},
      redacted_fields: [],
      manageAccount: (...args: any[]) =>
        callHubApi('user.manageAccount', ...args),
    },

    near: {
      createNamedAccount: (...args: any[]) =>
        callHubApi('near.createNamedAccount', ...args),
      ensureImplicitAccount: (...args: any[]) =>
        callHubApi('near.ensureImplicitAccount', ...args),
      walletDetails: (...args: any[]) =>
        callHubApi('near.walletDetails', ...args),
    },
  });
